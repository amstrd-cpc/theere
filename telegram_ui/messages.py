...
SHOP_INVENTORY_MENU_PROMPT = "📦 Inventory actions: pick an option."
SHOP_SALES_MENU_PROMPT = "💸 Sales actions: pick an option."
SHOP_REPORTS_MENU_PROMPT = "📈 Reports & summaries: pick an option."
WOO_MENU_PROMPT = "🛒 WooCommerce menu: pick an action."
WOO_SETUP_MENU_PROMPT = "🔧 Woo setup & sync: pick an option."
WOO_ORDERS_MENU_PROMPT = "📦 Woo orders: pick an option."
WOO_MAPPING_MENU_PROMPT = "🧭 Woo product mapping: pick an option."
DISCOGS_MENU_PROMPT = "💿 Discogs menu: pick an action."
DISCOGS_CONNECTION_MENU_PROMPT = "🔌 Discogs connection: pick an option."
DISCOGS_PUBLISH_MENU_PROMPT = "📣 Discogs publishing: pick an option."
DISCOGS_SYNC_MENU_PROMPT = "🔄 Discogs inventory sync: pick an option."
SETTINGS_MENU_PROMPT = "⚙️ Settings menu: pick an action."
SETTINGS_ACCOUNT_MENU_PROMPT = "👤 Account settings: pick an option."
SETTINGS_SUPPORT_MENU_PROMPT = "🆘 Support & help: pick an option."
...
HELP_AUTHENTICATED = (
    ...
    "• /publish\\_discogs\\_all \\- Publish all listings\n"
    "• /publish\\_discogs\\_selection \\- Publish selection\n"
    "• /collect\\_discogs \\- Add release to collection\n"
    "• /collect\\_discogs\\_all \\- Add all matches to collection\n"
