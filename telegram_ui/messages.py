...
INTEGRATIONS_MENU_PROMPT = "🔌 Integrations: pick WooCommerce or Discogs."
SYNC_MENU_PROMPT = "🔄 Sync menu: run and monitor synchronization tasks."
