...
from telegram_ui.keyboards import (
    ...
    DISCOGS_MENU_STATUS,
    INTEGRATIONS_MENU_DISCOGS,
    INTEGRATIONS_MENU_WOO,
    MAIN_MENU_BACKUPS,
    MAIN_MENU_INTEGRATIONS,
    MAIN_MENU_SETTINGS,
    MAIN_MENU_SHOP,
    MAIN_MENU_SYNC,
    MAIN_MENU_SYNC_STATUS,
...
MENU_COMMANDS = {
    ...
    INTEGRATIONS_MENU_WOO: "/integrations_woo",
    INTEGRATIONS_MENU_DISCOGS: "/integrations_discogs",
    DISCOGS_MENU_CONNECT: "/connect_discogs",
    DISCOGS_MENU_STATUS: "/discogs_status",
    DISCOGS_MENU_COLLECTION: "/collect_discogs",
    SYNC_MENU_OPEN: "/sync",
    MAIN_MENU_SYNC_STATUS: "/sync_status",
...
SUBMENUS = {
    ...
    MAIN_MENU_INTEGRATIONS: (build_integrations_menu, messages.INTEGRATIONS_MENU_PROMPT),
    MAIN_MENU_SYNC: (build_sync_menu, messages.SYNC_MENU_PROMPT),
...
BACK_TARGETS = {
    ...
    BACK_TO_INTEGRATIONS: (build_integrations_menu, messages.INTEGRATIONS_MENU_PROMPT, True),
    BACK_TO_SYNC: (build_sync_menu, messages.SYNC_MENU_PROMPT, True),
